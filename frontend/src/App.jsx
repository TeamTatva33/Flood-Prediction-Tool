  ...
  return (
    <div className="app">
      ...
      <div className="grid  grid-cols-2 grid-rows-2 gap-4 p-4 h-[80vh]">
        <Map className="col-start-1 col-end-2 row-start-1 row-end-3 rounded-xl h-full w-full" />
        <SafeZone
          title="Alerts"
          className="bg-gray-200 h-full w-full col-start-2 row-start-1 col-end-3 row-end-2 rounded-xl prediction border-2 border-gray-100 p-4 flex flex-col gap-4" colour='red'
        >
